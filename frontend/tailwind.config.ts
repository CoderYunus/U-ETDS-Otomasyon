  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        background: {
          light: "#f8fafc", // Daha premium açık gri/buz beyazı
          dark: "#0f172a", // Koyu mavi (midnight blue)
        },
        surface: {
          light: "rgba(255, 255, 255, 0.7)", // Yarı saydam beyaz
          dark: "rgba(30, 41, 59, 0.7)", // Yarı saydam koyu gri
        }
      },
      backgroundImage: {
